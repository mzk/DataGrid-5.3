...
class ActionColumn extends DataGridColumn implements ArrayAccess
{
	...
	{
		throw new Nette\InvalidStateException("ActionColumn cannot be formated.");
	}
	...
	{
		throw new Nette\InvalidStateException("ActionColumn cannot be filtered.");
	}
	...
	final public function offsetSet($name, $component)
	{
		if (!$component instanceof Nette\ComponentModel\IComponent) {
			throw new Nette\InvalidArgumentException("ActionColumn accepts only IComponent objects.");
		}
